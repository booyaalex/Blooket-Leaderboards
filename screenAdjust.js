...
if (width <= 644) {
  let screenMode = 1;
  document.getElementById("navBar").innerHTML = "<img src='https://toppng.com/uploads/preview/menu-icon-png-3-lines-11552739317jfnbfzzmez.png' alt='Open Side Nav' width='25px' style='float: left;'>";
}
console.log(width);
